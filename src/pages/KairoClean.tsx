    ...
    <div className="w-full text-white bg-[#0a0a0a] min-h-screen relative font-sans selection:bg-[#E1147B]">
      ...
      <section className="px-6 py-12 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <a href="#book-form" className="inline-block px-12 py-5 font-black uppercase tracking-widest text-sm shadow-[0_0_30px_rgba(225,20,123,0.3)] hover:scale-105 transition-transform" style={{ backgroundColor: PINK }}>Request a Quote</a>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { title: 'After-event', desc: 'Rapid-response mess removal for venues, festivals, and elite private parties.', icon: Clock },
              { title: 'Deep Cleaning', desc: 'Intensive top-to-bottom sanitization. We clear the grime that others choose to ignore.', icon: Check },
            ].map((s, i) => (
      ...
      {/* --- 4. ABOUT SECTION (Split 12-Column like KairoSec) --- */}
      <section className="px-6 py-24">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          {/* Left Text Column (5 cols) */}
          <div className="lg:col-span-5 p-12 border border-zinc-800 bg-[#0d0d0d] shadow-xl">
            <h2 className="text-4xl font-black uppercase mb-8 leading-none italic text-[#E1147B]">About KairoClean</h2>
            <p className="text-zinc-300 mb-8 italic text-lg leading-relaxed font-light">
              "Tactical cleaning isn't just about a wipe-down. It's about maintaining an elite standard of hygiene and presentation that protects your assets."
            </p>
            <div className="space-y-5 pt-8 border-t border-zinc-800">
              <div className="flex items-center gap-4 text-xs font-black uppercase tracking-widest font-bold"><Check size={18} style={{ color: PINK }} /> Fully Insured & Licensed</div>
              <div className="flex items-center gap-4 text-xs font-black uppercase tracking-widest font-bold"><Check size={18} style={{ color: PINK }} /> Elite Vetted Professionals</div>
              <div className="flex items-center gap-4 text-xs font-black uppercase tracking-widest font-bold"><Check size={18} style={{ color: PINK }} /> Flexible High-Spec Cleaning</div>
            </div>
          </div>

          {/* Right Value Grid (7 cols) */}
      ...
      {/* --- 5. BOOKING FORM (Visible Form like Join Page) --- */}
      ...
      <section className="px-6 py-24 text-center bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto rounded-[100px] border-[4px] p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-10 mb-20 shadow-2xl hover:shadow-[0_0_80px_rgba(225,20,123,0.3)] transition-all" style={{ borderColor: PINK }}>
          <div className="text-center md:text-left">
             <span className="block text-4xl md:text-5xl font-black uppercase tracking-tighter" style={{ color: PINK }}>Call For</span>
             <span className="block text-4xl md:text-5xl font-black uppercase tracking-tighter" style={{ color: PINK }}>Direct Quote</span>
          </div>
          <div className="flex items-center gap-8">
             <Phone size={60} style={{ color: PINK }} className="hidden sm:block" />
