  ...
  return (
    <div className="w-full text-white bg-[#0a0a0a] min-h-screen relative font-sans selection:bg-[#E1147B]">
      ...
      <div className="flex justify-center pt-16 pb-8 relative z-10">
        <div className="w-32 h-32 bg-[#0a0a0a] border-4 border-[#E1147B] rotate-45 flex items-center justify-center shadow-[0_0_40px_rgba(225,20,123,0.3)] hover:scale-110 transition-transform duration-500">
      ...
      <section className="px-6 py-12 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          <h1 className="text-6xl md:text-[7.5rem] font-black uppercase leading-[0.9] tracking-tighter mb-8 italic drop-shadow-2xl">
      ...
      <section className="px-6 py-24 bg-[#0d0d0d] border-y border-white/5 relative">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-5xl font-black uppercase mb-16 tracking-tight italic">Our <span style={{ color: PINK }}>Services</span></h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: 'Office Cleaning', desc: 'Surgical precision for corporate environments, ensuring your workspace reflects your brand.', icon: Building2 },
              ...
              { title: 'Deep Cleaning', desc: 'Intensive restoration cleaning. We clear the grime that others choose to ignore.', icon: Check },
            ].map((s, i) => (
      ...
      <section id="book-form" className="px-6 py-24 bg-[#0d0d0d] border-t border-white/5 relative">
        <div className="max-w-4xl mx-auto bg-[#0a0a0a] p-10 md:p-16 border border-zinc-800 shadow-2xl relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-zinc-500 font-bold uppercase tracking-[0.3em] text-xs underline decoration-[#E1147B]">Professional Response within 24 hours</p>
          </div>
      ...
      <footer className="py-16 px-6 border-t border-white/10 bg-[#0a0a0a] text-center">
        <div className="max-w-4xl mx-auto">
          <p className="text-white/30 text-[10px] uppercase font-black tracking-widest">(Registered in England and Wales)</p>
        </div>
      </footer>
