  ...
  return (
    <section className="w-full h-screen bg-black relative overflow-hidden flex flex-col md:flex-row">
      ...
      <a
        ...
        className="h-1/2 w-full md:h-full md:w-1/2 relative cursor-pointer overflow-hidden flex items-center justify-center"
      >
        <div
      ...
      {/* ── Divider ── */}
      <div className="w-full h-px md:h-full md:w-px flex-shrink-0 bg-gradient-to-r md:bg-gradient-to-b from-transparent via-white/15 to-transparent" />
